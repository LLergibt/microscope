  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        class={cn(
          "z-50 min-w-8rem overflow-hidden rounded-md border border-slate-200 bg-white p-1 text-slate-950 shadow-md data-[expanded]:animate-in data-[closed]:animate-out data-[closed]:fade-out-0 data-[expanded]:fade-in-0 data-[closed]:zoom-out-95 data-[expanded]:zoom-in-95 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-50",
          local.class
        )}
        {...rest}
      />
...
> = (props) => {
  ...
  return (
    <DropdownMenuPrimitive.Separator
      class={cn("-mx-1 my-1 h-px bg-slate-100 dark:bg-slate-800", local.class)}
      {...rest}
    />
  );
};
...
> = (props) => {
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      class={cn(
        "flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-slate-100 data-[expanded]:bg-slate-100 dark:focus:bg-slate-800 dark:data-[expanded]:bg-slate-800",
        local.class
      )}
      {...rest}
    >
